...
const Calculator = {
    ...
    // this will hold the operator, we seet it to null for now
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    // checks if an operator already ixists and if Wait_Second_Operand is true,
